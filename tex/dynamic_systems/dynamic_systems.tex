...
\section{Introduction}
  ...
  \begin{table}
    ...
    $(\approx 3.544, 4]$ & \begin{tabular}{l}For almost all inital points no oscillation with finite period. \\ Small changes in the initial point yield large differences over the iterations. \end{tabular} \\ \hline
  ...
  \end{figure}
  The behaviour of the logistic map depends on the parameter $a$.\\
  ...
  \subsection{The Algorithm}
    ...
    inverse function on $(0,1)$ is a contraction, thus 
    ...
    That is, a sequence of intervals $(I_n)_{0 \leq n \leq N}$ giving upper on
    lower bounds for $y_n$ is computed. 
    That is such that $y_n \in I_n \text{ for } 0 \leq n \leq N$.
