...
\subsection{Evaluation}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{img/dynamic_systems/shadowing_distance_dep_on_prec}
