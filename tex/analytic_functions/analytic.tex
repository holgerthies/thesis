%!TEX root = ../../thesis.tex
	...
	\section{Analytic Continuation}
		...
		\begin{definition}
			...
			\end{enumerate}
		\end{definition}
		A series name can be computed from a single series name by computing the series expansion on another point on the domain and then iterating this process until the series cover $[-1,1]$ (see Figure \ref{fig}).
