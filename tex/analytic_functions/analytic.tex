%!TEX root = ../../thesis.tex
    ...
    Thus it might be useful to consider subsets of real functions and investigate which of the operations become feasible.
		...
		One subset of real functions that has been thoroughly studied in computable analysis are the analytic functions.
    ...
    An analytic function is locally defined by it's Taylor series, that is
		\begin{definition}
