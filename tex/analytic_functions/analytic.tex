%!TEX root = ../../thesis.tex
	...
	\section{Introduction}
		...
		\begin{corollary}
			If $f$ is polynomial time computable the following functions are also polynomial time computable:
			\begin{enumerate}
	...
	\section{Representation of Analytic Functions}
	 ...
	 \end{theorem}
	 \begin{proof}[Sketch]
	 	A full proof can be found in \cite{Kaw}.  
	...
	Such functions can be represented by a finite number of power series covering the domain. 
	 \begin{figure}
	 	\centering
		...
		\end{subfigure}
	 	\begin{subfigure}{.45\textwidth}
			...
			\end{tikzpicture}
		\end{subfigure}
		\caption{Representations for analytic function}\label{fig: analytic function representations}
	 \end{figure}
